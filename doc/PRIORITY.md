...
|---|---|---|---|---|
| 1986-92 | Studied Physics, Kazan University (UofT certified this study as equivalent to a BSc). Fortran and Basic (1987), then C (K&R, Turbo C 2.0) studied for the coursework: interfacing Bruker Adacos 2000 NMR systems (a 24-bit SGI machine), for scientific spectroscopy and medical MRI, with a PC (386) | [TODO: any surviving records] | C | programming foundation; applied C, scientific + medical instrument interfacing |
| 1993-97 | Degree in CS. Coursework: a dBASE-like database (C structs, blobs, a binary format), minimax game AI, a Prolog expert system, C simulations, Ada 83 agents, and other programs. The initial idea to **store metadata** appeared here, held as **directory names** -- the seed of filesystem-as-index (1.2) | [TODO: any surviving coursework code] | C | early systems + AI breadth; root of the keys-as-directories idea |
...
| ~2006-18 | Professional career: ~12 years in government and ~13 years in medical IT [TODO: reconcile spans/dates]. Processed large-volume data records efficiently; built backend processors, rule-engines, predictive ("predicting machinery") and classification programs, and account-consolidation calculators, for the health-care ministry, hospitals, ambulances, and medical colleges | [TODO: employers] | C | high-volume data engineering + ML/prediction/classification in a regulated medical setting |
