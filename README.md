...
New code: dual licensed, your choice of GNU GPL v2 or later ([COPYING](COPYING)) or MIT ([LICENSE-MIT](LICENSE-MIT)). Legacy material (`legacy/`) under its original Apache License 2.0. Author: Vasili Gavrilov (GitHub [Anode1](https://github.com/Anode1)).
