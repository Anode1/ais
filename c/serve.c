...
"<style>"
":root{--accent:#1a0dab;--line:#e3e3ea;--muted:#54545e}*{box-sizing:border-box}"
...
"#bnav{position:fixed;left:0;right:0;bottom:0;z-index:6;display:flex;background:#fff;border-top:1px solid var(--line);box-shadow:0 -2px 12px rgba(0,0,0,.05)}"
...
".minibtn{border:1px solid var(--line);background:#fff;color:var(--muted);font:inherit;"
...
".daygroup{font-size:.85rem;color:#14141a;font-weight:700;text-transform:uppercase;letter-spacing:.04em;"
...
"<div class=searchrow><input id=q type=search placeholder='type keys, then Get' autocomplete=off autofocus>"
"<button id=seg-recall class=getbtn>Get</button></div>"
...
"<main id=out><p class=empty>Type keys, then Get. Click + Add to save.</p></main>"
"<button id=addbtn class=fab>+ Add</button>"
"<nav id=bnav><button data-v=recall class=on><span class=ic>&#128269;</span>Search</button>"
"<button data-v=timeline><span class=ic>&#128336;</span>Timeline</button>"
